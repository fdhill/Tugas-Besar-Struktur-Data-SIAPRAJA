...
public class DataGuruController {
    ...
    public DataGuruController(DataSourceGuru datasource, CRUDGuru view) {
        this.view = view;
        ...
        this.view.getjBtnTambah().addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new TambahGuruController(datasource, new TambahGuruView());
            }
        });
        ...
        this.view.getjBtnEdit().addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new EditGuruController(datasource, new TambahGuruView(), selectedTabelId);
                bassicLayout();
            }
        });
