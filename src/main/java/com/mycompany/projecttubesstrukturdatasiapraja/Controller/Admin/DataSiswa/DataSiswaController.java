...
public class DataSiswaController {
    ...
    public DataSiswaController(DataSourceSiswa datasource, CRUDSiswa view) {
        this.view = view;
        ...
        this.view.getjBtnTambah().addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new TambahSiswaController(datasource, new TambahSiswaView());
            }
        });
        ...
        this.view.getjBtnEdit().addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new EditSiswaController(datasource, new TambahSiswaView(), selectedTabelId);
                bassicLayout();
            }
        });
    }
