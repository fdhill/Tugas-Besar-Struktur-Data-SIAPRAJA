 ...
 * @author Pongo
 */
public class EditSiswaController {

    DataSourceSiswa datasource;
    TambahSiswaView view;

    public EditSiswaController(DataSourceSiswa datasource, TambahSiswaView view, int selectedTabelId) {
        ...
        this.view.getjBtnSimpan().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                datasource.update(selectedTabelId, nama, nisn, alamat, jenis_kelamin, kelas);
